...
/*    private boolean enableTests = System.getenv("publishing") != null &&
            ...
            throws Exception
    {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            /*
            {
                ...
                >
                (metadata: {
                    partitionCols=year,month,day}),
                    split=Split{
                            spillLocation=S3SpillLocation{
                                bucket='athena-virtuoso-test',
                                key='lambda-spill/c63e6d58-963c-413d-a8f2-231ef3e25332/61cfc487-c64a-4c08-b1d5-d5f7fb44ef1b',
                                directory=true
                            },
    ...
    {
        return new FederatedIdentity("arn", "account", new HashMap<>(), Collections.emptyList());
    }
