...
/**
 * started from <code>ExampleRecordHandlerTest</code>
 */

public class CassandraRecordHandlerTest {
    private static final Logger logger = LoggerFactory.getLogger(CassandraRecordHandlerTest.class);
    ...
    public void setUp() {
        ...
        recordService = new LocalHandler(cqlSession, allocator, amazonS3, awsSecretsManager, athena);
